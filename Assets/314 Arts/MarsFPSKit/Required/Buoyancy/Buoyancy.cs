...
//KIT NOTE:
//As I'm not really that much into physics yet, I decided to use this script
//Its under WTFPL License, so it's good to use.
//I got it here, if you want to learn more about it:
//https://forum.unity.com/threads/buoyancy-script.72974/
